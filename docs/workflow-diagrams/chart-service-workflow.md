...
- The chart service is a separate FastAPI application focused on astrology calculations and daily guidance.
- It uses Swiss Ephemeris-based calculations and background cache refresh logic.
- The service can be run independently from the main backend.
