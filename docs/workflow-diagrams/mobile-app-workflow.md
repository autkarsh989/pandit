...
- The mobile app uses Expo Router, not React Router.
- The app keeps auth state in AsyncStorage and redirects based on `userType`.
- The tab layout hides certain sections for pandit accounts so the experience stays role-aware.
